...
export const work: Work[] = [
  {
    ...
    dates: "Spring 2026",
    description:
      "Shipped production features and developer tooling across the stack",
    longDescription:
      "I had a lot of fun interning at Instant Risk Coverage Inc. (IRC) and learned a ton. Here are some of my achievements:\n\n• Built a Claude Code–powered PR-review visualizer that generates import-impact, module-dependency, and function-call graphs, with cycle detection, for JS/TS and Python repos.\n• Audited a 4.3K-line Python/SQLite knowledge engine, reproducing 22 defects with line citations and runnable verification commands.\n• Created xrefscope, a dependency-free SQLite-to-HTML viewer that renders the knowledge engine as a static offline page, validated by 71 unit tests.\n• Engineered the platform's first USD payment support, routing Stripe account, currency, and tax through a MongoDB flag and a generated deploy matrix (Python, GitHub Actions, Docker), now shipped to production and in active use, reducing new-market portal enablement to a config change.\n• Built a Mage/PostgreSQL ETL pipeline for e-commerce order reporting with idempotent upserts and fan-out guards, now running in production and in active use.\n• Fast-tracked the company-wide AI governance handbook by authoring key sections and resolving 73 of 77 review threads.\n• Supported TechOps for the insurance portals: onboarding, cancellations, debugging, and iterative reliability improvements.",
    images: [
      { src: "/gallery/experience/work_1/IRC-Logo-Maple-Leaf-home-feat.png", caption: "Company Logo" },
      { src: "/gallery/experience/work_1/setup.png", caption: "My workspace setup at IRC — yes, that's two Claude Code agents on the screen." },
      { src: "/gallery/experience/work_1/cake.png", caption: "A celebratory cake at the IRC office — don't ask why my picture is on it." }
    ],
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    images: [{ src: "/gallery/projects/ScholarCompare/scholar_compare_screenshot.jpg", caption: "A screenshot of the web app running, showing its user interface." }],
